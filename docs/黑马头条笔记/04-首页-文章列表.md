...
2. label部分插槽
   ...
   <img src="assets/image-20211225205005422.png" alt="image-20211225205005422" style="zoom:40%;" />
...
3. 如果只有一张图片情况下，需要在右侧value插槽部分展示自定义图片内容 ==> 单个图片插槽
   ...
   <img src="assets/image-20211225205154777.png" alt="image-20211225205154777" style="zoom:50%;" />
